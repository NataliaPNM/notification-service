...
class ConfirmationCodeServiceTest {
    ...
    @Mock
    private ConfirmationCodeLockRepository confirmationCodeLockRepository;
    @Mock
    private SendersFactory sendersFactory;
    @Mock
    private EmailSender emailSender;
    @Mock
    private PersonContactsService userService;

    @Test
    void sendCodeTest() throws IOException {
        Person person = Fixtures.getUser("ttt@yandex.ru");
        ...
        when(userService.getUserByIdSync(UUID.fromString("f8c3de3d-1fea-4d7c-a8b0-29f63c4c3454"))).thenReturn(person);
        when(confirmationCodeLockRepository.findByUserIdAndCodeType(UUID.fromString("f8c3de3d-1fea-4d7c-a8b0-29f63c4c3454"), "email"))
